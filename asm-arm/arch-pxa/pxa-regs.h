...
#define MCR_LOOP	(1 << 4)	/* force loop */
...
#define PXA_SACR0	__REG(0x40400000)  /* Global Control Register */
#define PXA_SACR1	__REG(0x40400004)  /* Serial Audio I 2 S/MSB-Justified Control Register */
#define PXA_SASR0	__REG(0x4040000C)  /* Serial Audio I 2 S/MSB-Justified Interface and FIFO Status Register */
#define PXA_SAIMR	__REG(0x40400014)  /* Serial Audio Interrupt Mask Register */
#define PXA_SAICR	__REG(0x40400018)  /* Serial Audio Interrupt Clear Register */
#define PXA_SADIV	__REG(0x40400060)  /* Audio Clock Divider Register. */
#define PXA_SADR	__REG(0x40400080)  /* Serial Audio Data Register (TX and RX FIFO access Register). */
...
#define IC_GPIO0	(1 << 8)	/* GPIO  [0]                       */
#define IC_GPIO1	(1 << 9)	/* GPIO  [1]                       */
...
#define GPIO_OUT		0x0080
#define GPIO_ALT_FN_1_IN	0x0100
#define GPIO_ALT_FN_1_OUT	0x0180
#define GPIO_ALT_FN_2_IN	0x0200
#define GPIO_ALT_FN_2_OUT	0x0280
#define GPIO_ALT_FN_3_IN	0x0300
#define GPIO_ACTIVE_LOW         0x1000
#define GPIO_ALT_FN_3_OUT	0x0380
#define GPIO_MD_MASK_NR		0x007f
#define GPIO_MD_MASK_DIR	0x0080
#define GPIO_MD_MASK_FN		0x0300
#define GPIO_MD_MASK_LVL        0x1000
...
#define GPIO15_nCS_1_MD		(15 | GPIO_ALT_FN_2_OUT | GPIO_ACTIVE_LOW)
...
#define GPIO33_nCS_5_MD		(33 | GPIO_ALT_FN_2_OUT | GPIO_ACTIVE_LOW)
...
#define GPIO48_nPOE_MD		(48 | GPIO_ALT_FN_2_OUT | GPIO_ACTIVE_LOW)
#define GPIO49_nPWE_MD		(49 | GPIO_ALT_FN_2_OUT | GPIO_ACTIVE_LOW)
#define GPIO50_nPIOR_MD		(50 | GPIO_ALT_FN_2_OUT | GPIO_ACTIVE_LOW)
#define GPIO51_nPIOW_MD		(51 | GPIO_ALT_FN_2_OUT | GPIO_ACTIVE_LOW)
#define GPIO52_nPCE_1_MD	(52 | GPIO_ALT_FN_2_OUT | GPIO_ACTIVE_LOW)
#define GPIO53_nPCE_2_MD	(53 | GPIO_ALT_FN_2_OUT | GPIO_ACTIVE_LOW)
#define GPIO53_MMCCLK_MD	(53 | GPIO_ALT_FN_1_OUT)
#define GPIO54_MMCCLK_MD	(54 | GPIO_ALT_FN_1_OUT)
#define GPIO54_pSKTSEL_MD	(54 | GPIO_ALT_FN_2_OUT)
#define GPIO55_nPREG_MD		(55 | GPIO_ALT_FN_2_OUT | GPIO_ACTIVE_LOW)
...
#define GPIO78_nCS_2_MD		(78 | GPIO_ALT_FN_2_OUT | GPIO_ACTIVE_LOW)
#define GPIO79_nCS_3_MD		(79 | GPIO_ALT_FN_2_OUT | GPIO_ACTIVE_LOW)
#define GPIO80_nCS_4_MD		(80 | GPIO_ALT_FN_2_OUT | GPIO_ACTIVE_LOW)
...
#define PMCR_IDAE       (1 << 0)        /* enable imprecise data aborts.  recommended mode. */
...
#define SSCR0_FRF_SSP   (1 << 4)
#define SSCR0_FRF_MICROWIRE (2 << 4)

#define SSCR0_ECS_ONCHIP_CLOCK (0 << 6)
#define SSCR0_ECS_USE_SSPEXTCLK (1 << 6)

#define SSCR0_SSE_ENABLED (1 << 7)
...
#define SSSR_TFL_WIDTH 4
#define SSSR_RFL_SHIFT 12
#define SSSR_RFL_WIDTH 4
...
#define LCCR2_EndFrmDel(Tln)            /*  End-of-Frame Delay             */ \
                                        /*  [0..255 Tln]                   */ \
                        (((Tln) - 1) << FShft (LCCR2_EFW))

#define LCCR2_BFW       Fld (8, 24)     /* Beginning-of-Frame line clock   */
                                        /* Wait count [Tln]                */
#define LCCR2_BegFrmDel(Tln)            /*  Beginning-of-Frame Delay       */ \
                                        /*  [0..255 Tln]                   */ \
                        (((Tln) - 1) << FShft (LCCR2_BFW))
...
#define MSC1_Bnk4	MSC_Bnk (5)	/* static memory Bank 4            */
#define MSC1_Bnk5	MSC_Bnk (5)	/* static memory Bank 5            */

#define MSC_RT  	Fld (3, 0)	/* ROM/static memory Type          */
...
#define MSC_Brst8	        	/*  Burst-of-8 static memory       */ \
                	FInsrt (3, MSC_RT)
#define MSC_VLIO	        	/*  Vairable Latency I/O           */ \
                	FInsrt (4, MSC_RT)
#define MSC_RBW 	0x0008  	/* ROM/static memory Bus Width     */
#define MSC_32BitStMem	(MSC_RBW*0)	/*  32-Bit Static Memory           */
#define MSC_16BitStMem	(MSC_RBW*1)	/*  16-Bit Static Memory           */
#define MSC_RDF 	Fld (4, 4)	/* ROM/static memory read Delay    */
                	        	/* First access - 1(.5) [Tmem]     */
#define MSC_RDN 	Fld (4, 8)	/* ROM/static memory read Delay    */
                	        	/* Next access - 1 [Tmem]          */
#define MSC_RRR 	Fld (3, 12)	/* ROM/static memory RecoveRy      */
                	        	/* time/2 [Tmem]                   */
#define MSC_RBUFF       Fld (1, 15)     /* Return Data Buffer vs Streaming behavior */ 
#define MSC_RBUFF_STREAMING FInsrt (1, MSC_RBUFF)
#endif
